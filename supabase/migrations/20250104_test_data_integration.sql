-- =============================================
-- Test Data Integration Migration
-- =============================================
...
CREATE INDEX idx_test_data_measurements_cluster_project ON public.test_data_measurements(cluster_project_id);
CREATE INDEX idx_test_data_measurements_owner ON public.test_data_measurements(owner_id);
CREATE INDEX idx_test_data_measurements_type ON public.test_data_measurements(measurement_type);
CREATE INDEX idx_test_data_measurements_test_date ON public.test_data_measurements(test_date DESC);
CREATE INDEX idx_test_data_measurements_validation ON public.test_data_measurements(validation_status);
...
CREATE INDEX idx_test_data_files_cluster_project ON public.test_data_files(cluster_project_id);
CREATE INDEX idx_test_data_files_owner ON public.test_data_files(owner_id);
CREATE INDEX idx_test_data_files_type ON public.test_data_files(file_type);
...
CREATE INDEX idx_test_data_exports_user ON public.test_data_exports(user_id);
CREATE INDEX idx_test_data_exports_status ON public.test_data_exports(status);
CREATE INDEX idx_test_data_exports_requested_at ON public.test_data_exports(requested_at DESC);
...
CREATE INDEX idx_test_data_templates_owner ON public.test_data_templates(owner_id);
CREATE INDEX idx_test_data_templates_type ON public.test_data_templates(template_type);
CREATE INDEX idx_test_data_templates_public ON public.test_data_templates(is_public);

-- =============================================
-- Views for Convenience
-- =============================================

-- View: Test data projects with measurement counts
...
LEFT JOIN public.clusters c ON cp.cluster_id = c.id
