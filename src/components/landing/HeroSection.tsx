    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      >
        ...
        >
          ...
          <span className="text-gradient-cyan">Instantly Accessible</span>
        </motion.h1>
        ...
        >
          A RAG-powered platform for device measurement data. Create limits from historical data,
          calculate real-time yield, and conduct failure analysis across all stages of product development.
        </motion.p>
