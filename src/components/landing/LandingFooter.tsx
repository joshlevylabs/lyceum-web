  ...
  return (
    <footer className="border-t border-foreground/10">
      <div className="max-w-7xl mx-auto px-6 py-16">
        ...
        >
          ...
          <motion.div variants={fadeInUp} className="col-span-2 md:col-span-4 lg:col-span-1">
            ...
            <p className="text-sm text-foreground/50 mb-6 max-w-xs">
              The cloud-based industrial analytics platform for engineers and analysts.
            </p>
            {/* Social links */}
            <div className="flex gap-4">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="text-foreground/40 hover:text-cyan-400 transition-colors"
              ...
              <ul className="space-y-3">
                {column.links.map((link) => (
                  <li key={link.label}>
                    <Link
                      href={link.href}
                      className="text-sm text-foreground/50 hover:text-cyan-400 transition-colors"
                    >
                      {link.label}
                    </Link>
                  </li>
        ...
        {/* Bottom bar */}
        <motion.div
          className="mt-16 pt-8 border-t border-foreground/10 flex flex-col md:flex-row items-center justify-between gap-4"
          initial={{ opacity: 0 }}
        ...
        >
          ...
          <div className="flex items-center gap-6">
            ...
            <Link href="/cookies" className="text-sm text-foreground/40 hover:text-foreground/60 transition-colors">
              Cookies
            </Link>
          </div>
        </motion.div>
