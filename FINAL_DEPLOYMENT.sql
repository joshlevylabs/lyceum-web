...
-- ============================================================
-- STEP 3: Set default organization brands
-- ============================================================
...
-- ============================================================
-- STEP 5: Verify organizations have brand_type
-- ============================================================
...
-- ✅ Added brand_type columns to organizations and application_versions
...
-- ✅ All organizations default to 'lyceum' brand
-- ✅ Indexes created for performance

-- Next steps:
-- 1. Deploy updated API code (if not already done)
-- 2. Test Lyceum user download
-- 3. Test Centcom user download (change org brand_type)
